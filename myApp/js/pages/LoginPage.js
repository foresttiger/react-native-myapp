...
import px2dp from '../apps/util'
import LocalImg from '../apps/images'
    ...
    <View style={styles.container}>
        <Image source={LocalImg['usr']} style={styles.logo}/>
         <Hideo
            ...
            style={{height:60,maxHeight: 60,marginTop: 30,width: _width}}
            // this is used as backgroundColor of icon container view.
            iconBackgroundColor={'#c0a354'}
            inputStyle={{ height:60,color: '#464949',fontSize:px2dp(14)}}
          />
          <Hideo
            iconClass={FontAwesomeIcon}
            iconName={'lock'}
            ...
            // this is used as backgroundColor of icon container view.
            iconBackgroundColor={'#c0a354'}
            inputStyle={{ height:isIOS?40:60,color: '#464949',fontSize:px2dp(14)}}
          />
        ...
        <View style={styles.loginBack}> 
          <Image source={LocalImg['loginBack']} style={{width: width,height:height}}/>
        </View>
    </View>
) } }
