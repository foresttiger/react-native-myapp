...
        connectionInfo: null,
  ...
  _renderTypes(){
    ...
    //     prevButton = {<Text style={{fontSize:60, color:'#c0a354'}}>‹</Text>}
    //     nextButton = {<Text style={{fontSize:60, color:'#c0a354'}}>›</Text>}
    //     showsPagination={true}
    //     dotStyle={{backgroundColor:'#ffffff', width: 8, height: 8}}
    //     activeDotStyle={{backgroundColor:'#c0a354', width: 8, height: 8}}>
    //     {renderSwipeView(['土豪推荐'], 0)}
    //     {renderSwipeView(['土豪推荐'], 1)}
    //     {renderSwipeView(['土豪推荐'], 2)}
    //     {renderSwipeView(['土豪推荐'], 3)}
